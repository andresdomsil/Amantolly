...
export class BusquedaPage {
  ...
  constructor(public e: Events, public toast: ToastController, public navCtrl: NavController, public navParams: NavParams, public http: Http) {
    var link = 'http://sedely.com.mx/amantolly/controllers/productosController.php?op=4';
    http.get(link)
            .subscribe(data => {
  ...
  addCarrito(id){
    var link = 'http://sedely.com.mx/Amantolly/controllers/carritoControllersinSession.php?op=1&id='+id+'&cantidad=1';
    this.http.get(link)
            .subscribe(() => {
